package top.cutexingluo.core.basepackage.baseimpl;
...
import top.cutexingluo.core.basepackage.base.BaseCallableSupplier;
import top.cutexingluo.core.basepackage.base.BaseAround;
import top.cutexingluo.core.basepackage.base.ComCallable;
import top.cutexingluo.core.basepackage.base.ComSupplier;
...
public class XTCallable<T>  implements BaseCallableSupplier<T>,
...
//                e.printStackTrace(); // 直接输出
    ...
    public <O> Callable<O> decorate(Callable<O> task) {
        return BaseAround.getTryCallable(task);
    }


    @Override
    public <O> Supplier<O> decorate(Supplier<O> task) {
        return BaseAround.getTrySupplier(task);
    }
}
