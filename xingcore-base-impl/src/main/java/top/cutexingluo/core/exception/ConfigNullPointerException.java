package top.cutexingluo.core.exception;
...
import top.cutexingluo.core.common.result.StrResult;
 ...
 */
@Getter
public class ConfigNullPointerException extends NullPointerException  implements IResultData<String>, IntCode {
    /**
     * 错误码
     */
