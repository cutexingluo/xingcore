package top.cutexingluo.core.common.valid.num.doublestatus;
    ...
    public boolean isValid(Double value) {
        if (value == null) {
            ...
            if (statusConfig.limit) {
                double valueUp = XTMathCore.getUpValue(value, statusConfig.eps);
                double valueDown = XTMathCore.getDownValue(value, statusConfig.eps);
