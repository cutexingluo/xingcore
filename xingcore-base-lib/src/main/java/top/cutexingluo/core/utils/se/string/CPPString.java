...
public class CPPString implements BaseCPPString, Comparable<String>, CharSequence {
    ...
    @Override
    public CPPString assign(String str) {
        this.string = str;
        return this;
    }

    @Override
    public CPPString assign(@NotNull String str, int begIndex, int len) {
        this.string = str.substring(begIndex, begIndex + len);
        return this;
    }

    @Override
    public CPPString assign(int count, char ch) {
    ...
    @Override
    public CPPString assign(int count, String str) {
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < count; i++) {
            sb.append(str);
        }
    ...
    @Override
    public CPPString append(String str) {
        this.string += str;
        return this;
    }

    @Override
    public CPPString append(@NotNull String str, int begIndex, int len) {
        this.string += str.substring(begIndex, begIndex + len);
        return this;
    }

    @Override
    public CPPString append(int count, char ch) {
    ...
    @Override
    public CPPString append(int count, String str) {
        StringBuilder sb = new StringBuilder(this.string);
        for (int i = 0; i < count; i++) {
            sb.append(str);
        }
    ...
    public int find(String subString, int startIndex) {
        return XTStringAlgo.find(this.string, startIndex, subString);
    }
    ...
    public int rFind(String subString, int startIndexToPre) {
        return XTStringAlgo.rFind(this.string, startIndexToPre, subString);
    }
    ...
    public int findFirstOf(String charCollection, int startIndex) {
        return XTStringAlgo.findFirstOf(this.string, startIndex, charCollection, false);
    }
    ...
    public int findLastOf(String charCollection, int startIndex) {
        return XTStringAlgo.findLastOf(this.string, startIndex, charCollection, false);
    }
    ...
    public int findFirstNotOf(String charCollection, int startIndex) {
        return XTStringAlgo.findFirstNotOf(this.string, startIndex, charCollection, false);
    }
    ...
    public int findLastNotOf(String charCollection, int startIndex) {
        return XTStringAlgo.findLastNotOf(this.string, startIndex, charCollection, false);
    }
    ...
    @Override
    public CPPString replace(int beginIndex, int len, @NotNull String str, int strBegIndex, int strLen) {
    ...
    @Override
    public CPPString replace(int beginIndex, int len, @NotNull String str, int strBegIndex) {
        StringBuilder builder = new StringBuilder(this.string);
        this.string = builder.replace(beginIndex, beginIndex + len,
    ...
    @Override
    public CPPString replace(int beginIndex, int len, String str) {
        StringBuilder builder = new StringBuilder(this.string);
        this.string = builder.replace(beginIndex, beginIndex + len,
                str).toString();
        return this;
    ...
    @Override
    public CPPString replace(int beginIndex, int len, int count, String str) {
        StringBuilder builder = new StringBuilder(this.string);
    ...
    @Override
    public CPPString erase(int beginIndex, int len) {
        StringBuilder builder = new StringBuilder(this.string)
    ...
    @Override
    public CPPString erase(int beginIndex) {
        StringBuilder builder = new StringBuilder(this.string)
    ...
    @Override
    public CPPString eraseCharAt(int index) {
        StringBuilder builder = new StringBuilder(this.string)
                .deleteCharAt(index);
        this.string = builder.toString();
        return this;
    ...
    @Override
    public CPPString insert(int beginIndex, String str) {
        StringBuilder builder = new StringBuilder(this.string)
    ...
    @Override
    public CPPString insert(int beginIndex, int count, String str) {
        String s = new CPPString().assign(count, str).toString();
        StringBuilder builder = new StringBuilder(this.string)
                .insert(beginIndex, s);
        this.string = builder.toString();
