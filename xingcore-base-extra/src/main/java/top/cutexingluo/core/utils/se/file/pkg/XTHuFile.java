...
@NoArgsConstructor
@AllArgsConstructor
public class XTHuFile extends XTFile{
    /**
     * 原始名
     */
     ...
     */
    public XTHuFile(String originalFilename, String uuid, String type, Long size) {
     ...
     * 不会生成 fileUUID , 需手动调用
     */
    public XTHuFile(String originalFilename, String uuid, String type, Long size, String md5) {
     ...
     */
    public XTHuFile(File file, boolean useOriginalFilenameFirst) {
     ...
     */
    public XTHuFile(File file, boolean useOriginalFilenameFirst, boolean genMd5, boolean genUUID) {
