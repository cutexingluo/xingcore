package top.cutexingluo.core.utils.encode.digest.md5;
...
public class Md5 {
    ...
    public String encode(String data, @NotNull ALGO algo, Meta meta) throws NoSuchAlgorithmException {
        switch (algo) {
            case Security:
                return Md5Handler.newInstance().encodeBySecurityFormat(data);
            case Salt:
    ...
    public boolean validate(@NotNull String data, String encrypted, @NotNull ALGO algo, Meta meta) throws NoSuchAlgorithmException {
        switch (algo) {
            case Security:
                return Md5Handler.newInstance().encodeBySecurityFormat(data).equals(encrypted);
            case Salt:
    ...
    public String encodeBySalt(String data, Meta meta) {
        ...
        MD5 md5 = new MD5(meta.getSalt().getBytes(),
