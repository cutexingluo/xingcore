package top.cutexingluo.core.designtools.juc.utils;
...
import top.cutexingluo.core.designtools.juc.impl.XTRunAndCallList;
 ...
 * <p>不推荐用该类，推荐使用 {@link  top.cutexingluo.core.designtools.juc.async.XTAsync}</p>
 *
 * @author XingTian
 * @version 1.0.0
 * @date 2023/4/6 22:06
